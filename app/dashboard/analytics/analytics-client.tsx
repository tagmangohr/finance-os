    ...
    <div className="space-y-3 max-w-[1400px]">
      ...
      <div className="animate-enter">
        <CustomizableCards
          ...
          cards={[
            { key: "net_revenue", label: "Net Revenue", node: <MetricCard title="Net Revenue" value={money(headline.netRevenue)} numericValue={headline.netRevenue} format="currency" icon={<TrendingUp className="size-4" />} accentColor="#10b981" subtitle="Gross − refunds − chargebacks" /> },
            { key: "net_profit", label: "Net Profit", node: <MetricCard title="Net Profit" value={money(headline.netProfit)} numericValue={headline.netProfit} format="currency" icon={headline.netProfit >= 0 ? <TrendingUp className="size-4" /> : <TrendingDown className="size-4" />} accentColor={headline.netProfit >= 0 ? "#10b981" : "#f43f5e"} subtitle="After all operating expenses" /> },
            { key: "net_margin", label: "Net Margin", node: <MetricCard title="Net Margin" value={pct(headline.netMargin)} numericValue={headline.netMargin} format="percent" icon={<Percent className="size-4" />} accentColor="#6366f1" subtitle="Net profit ÷ net revenue" /> },
            { key: "avg_mom", label: "Avg MoM Growth", node: <MetricCard title="Avg MoM Growth" value={pct(headline.avgMonthlyGrowth)} numericValue={headline.avgMonthlyGrowth ?? undefined} format="percent" icon={headline.avgMonthlyGrowth && headline.avgMonthlyGrowth < 0 ? <TrendingDown className="size-4" /> : <TrendingUp className="size-4" />} accentColor={headline.avgMonthlyGrowth && headline.avgMonthlyGrowth < 0 ? "#f43f5e" : "#10b981"} subtitle="Net revenue, month over month" /> },

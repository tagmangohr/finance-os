          ...
          <table className="w-full border-collapse text-[12.5px]">
            <thead>
              <tr className="border-b-2 border-border">
                ...
                {cols.map((c) => (
                  <th key={c.key} className={cn("sticky top-0 z-[4] bg-card text-right font-semibold text-muted-foreground px-3 py-2.5 whitespace-nowrap min-w-[96px] border-l border-border/60", c.key === "__ytd__" && "font-bold text-foreground")}>{c.label}</th>
                ))}
              </tr>
            </thead>
            <tbody>

    ...
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <div className="h-3 w-60 rounded-lg bg-white/[0.04] animate-pulse" />
        </div>
      ...
      >
        ...
        <div className="p-3 space-y-2">
          {[0, 1, 2].map((i) => (
            <div key={i} className="flex items-center gap-3 px-3.5 py-3 rounded-xl border border-white/[0.05]">
